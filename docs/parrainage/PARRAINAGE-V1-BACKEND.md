...
- `orders/<id>.referral` est un instantané serveur versionné : base et seuil avant remise, remise totale, allocation par ligne et empreinte. Il ne contient pas le UID parrain. Le checkout normal ne construit pas encore cet instantané ni la remise ; la fabrique sert à l’injection locale et au prochain lot.
