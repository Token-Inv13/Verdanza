      ...
      {promotions.map((promotion) => {
        ...
        return (
          <section
            ...
            className="rounded-lg border border-champagne/40 bg-ivory p-4"
          >
                ...
                {promotion.availableProducts.map((product) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      <strong className="mt-2 block text-sm text-forest">{product.name}</strong>
                      <span className="text-xs text-ink/55">
                        {promotion.unlockedQuantityGrams} g offerts · stock disponible {product.availableStock} g
                      </span>
                    </button>
                  );
                })}
            ...
            {selected && promotion.unlockedQuantityGrams > 0 && (
              <div className="mt-4 flex items-center justify-between rounded-md bg-forest px-3 py-2 text-sm text-ivory">
                <span>
